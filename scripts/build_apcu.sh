...
PHPIZE=${1:?usage: build_apcu.sh /path/to/phpize /path/to/php-config /path/to/output-dir [work-dir]}
PHP_CONFIG=${2:?usage: build_apcu.sh /path/to/phpize /path/to/php-config /path/to/output-dir [work-dir]}
OUTPUT_DIR=${3:?usage: build_apcu.sh /path/to/phpize /path/to/php-config /path/to/output-dir [work-dir]}
